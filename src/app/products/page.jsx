...
const Products = async () => {
    ...
    // console.log(product);className="inline-flex items-center gap-2 text-xs font-bold tracking-wider text-gray-400 hover:text-[#5C1D24] transition-colors uppercase mb-8"
    return (
        <div>
